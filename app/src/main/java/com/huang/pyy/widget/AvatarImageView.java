...
//                                        0xffffbb44,
//                                        0xff44aaff};
    public static final int[] COLORS = {0xff5e97e6,
                                        0xff86d22c,
                                        0xffe89e47,
                                        0xffeb6233,
                                        0xffef8c2e,
    ...
    public void setBoarderColor(int mBoarderColor) {
        this.mBoarderColor = mBoarderColor;
    }

    public void setBoarderWidth(int mBoarderWidth) {
        this.mBoarderWidth = mBoarderWidth;
    }

    public void setTextSizeRatio(float mTextSizeRatio) {
        this.mTextSizeRatio = mTextSizeRatio;
    }

    public void setTextMaskRatio(float mTextMaskRatio) {
        this.mTextMaskRatio = mTextMaskRatio;
    }

    public void setShowBoarder(boolean mShowBoarder) {
        this.mShowBoarder = mShowBoarder;
    }
    ...
    public void setTextAndColorSeed(String text) {
        setTextAndColor(convertNameToAvatarText(text), getColorBySeed(text));
//        setTextAndColor(convertNameToAvatarText(text), Color.parseColor(convertStringToColor(text)));
    }
    ...
    public String convertStringToColor(String text) {
        return TextUtils.isEmpty(text) ? DEFAULT_PLACEHOLDER_COLOR : String.format(COLOR_FORMAT, (0xFFFFFF & text.hashCode()));
    }
